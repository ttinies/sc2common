...
def test_ActualRaces():
    def case(a, b, compare):
        print("%5s %5s %5s   "%(a<b, a>b, a==b), a, b, compare)
        if   compare < 0:   assert a < b
        elif compare > 0:   assert a > b
        else:               assert a == b
    assert types.ActualRaces(c.ZERG)
    case(types.ActualRaces(None     ),                   c.TERRAN  , -1)
    case(types.ActualRaces(None     ),                   c.ZERG    , -1)
    case(types.ActualRaces(None     ),                   c.PROTOSS , -1)
    case(types.ActualRaces(None     ),                   None      ,  0)
    case(types.ActualRaces(c.TERRAN ),                   c.TERRAN  ,  0)
    case(types.ActualRaces(c.TERRAN ),                   c.ZERG    , -1)
    case(types.ActualRaces(c.TERRAN ),                   c.PROTOSS , -1)
    case(types.ActualRaces(c.TERRAN ),                   None      ,  1)
    case(types.ActualRaces(c.ZERG   ),                   c.TERRAN  ,  1)
    case(types.ActualRaces(c.ZERG   ),                   c.ZERG    ,  0)
    case(types.ActualRaces(c.ZERG   ),                   c.PROTOSS , -1)
    case(types.ActualRaces(c.ZERG   ),                   None      ,  1)
    case(types.ActualRaces(c.PROTOSS),                   c.TERRAN  ,  1)
    case(types.ActualRaces(c.PROTOSS),                   c.ZERG    ,  1)
    case(types.ActualRaces(c.PROTOSS),                   c.PROTOSS ,  0)
    case(types.ActualRaces(c.PROTOSS),                   None      ,  1)
    case(                  None      , types.ActualRaces(c.TERRAN ), -1)
    case(                  None      , types.ActualRaces(c.ZERG   ), -1)
    case(                  None      , types.ActualRaces(c.PROTOSS), -1)
    case(                  None      , types.ActualRaces(None     ),  0)
    case(                  c.TERRAN  , types.ActualRaces(c.TERRAN ),  0)
    case(                  c.TERRAN  , types.ActualRaces(c.ZERG   ), -1)
    case(                  c.TERRAN  , types.ActualRaces(c.PROTOSS), -1)
    case(                  c.TERRAN  , types.ActualRaces(None     ),  1)
    case(                  c.ZERG    , types.ActualRaces(c.TERRAN ),  1)
    case(                  c.ZERG    , types.ActualRaces(c.ZERG   ),  0)
    case(                  c.ZERG    , types.ActualRaces(c.PROTOSS), -1)
    case(                  c.ZERG    , types.ActualRaces(None     ),  1)
    case(                  c.PROTOSS , types.ActualRaces(c.TERRAN ),  1)
    case(                  c.PROTOSS , types.ActualRaces(c.ZERG   ),  1)
    case(                  c.PROTOSS , types.ActualRaces(c.PROTOSS),  0)
    case(                  c.PROTOSS , types.ActualRaces(None     ),  1)
